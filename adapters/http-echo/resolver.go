...
func (h *HeaderResolver) Resolve(c echo.Context) (string, error) {
...
func (s *SubdomainResolver) Resolve(c echo.Context) (string, error) {
	host := c.Request().Host
...
func (p *PathResolver) Resolve(c echo.Context) (string, error) {
...
// ParamResolver extracts tenant ID from Echo URL parameter.
...
// Resolve extracts tenant ID from Echo URL parameter.
func (p *ParamResolver) Resolve(c echo.Context) (string, error) {
...
func (q *QueryParamResolver) Resolve(c echo.Context) (string, error) {
	paramName := q.ParamName
	if paramName == "" {
		paramName = "tenant"
	}

	tenantID := c.QueryParam(paramName)
	if tenantID == "" {
...
func (ch *ChainResolver) Resolve(c echo.Context) (string, error) {
...
func (s *StaticResolver) Resolve(c echo.Context) (string, error) {
	if s.TenantID == "" {
